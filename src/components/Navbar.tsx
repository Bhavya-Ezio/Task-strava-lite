...
const Navbar = () => {
    ...
    // Effect to set the greeting based on the time of day and redirect if needed
    useEffect(() => {
                    ...
                    <div className="flex items-center space-x-6">
                        {navLinks.map((link) => (
                            <button
                                ...
                                className={`relative text-lg font-medium transition-colors duration-300 px-0 bg-transparent border-none outline-none ${
